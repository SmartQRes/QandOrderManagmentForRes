...
//    }
    ...
    func getBranchById(bra_id : NSNumber, uiView : ViewGeneralInfoViewController) -> Void {
        ...
        uiView.labelName.text = MyVariables.defaultBranch.bra_name as String
        uiView.labelBranchLocation.text = MyVariables.defaultBranch.bra_location as String
        uiView.labelBranchTime.text = MyVariables.defaultBranch.bra_service_time as String
        uiView.labelBranchStatus.text = MyVariables.defaultBranch.bra_status_name as String
        
        uiView.labelBranchContactNo.text = MyVariables.defaultBranch.bra_contact_no as String
        uiView.editBranch = MyVariables.defaultBranch
        uiView.labelShoppingMall.text = MyVariables.defaultBranch.bra_shop_name as String
...
//        })
    ...
    func getBranchById(bra_id : NSNumber, uiView : ViewTableTypeSettingViewController) -> Void {
        uiView.labelAMax.text = MyVariables.defaultBranch.bra_ty_a_max.stringValue
        uiView.labelBMax.text = MyVariables.defaultBranch.bra_ty_b_max.stringValue
        uiView.labelCMax.text = MyVariables.defaultBranch.bra_ty_c_max.stringValue
        uiView.labelDMax.text = MyVariables.defaultBranch.bra_ty_d_max.stringValue
        uiView.labelATurnOver.text = MyVariables.defaultBranch.bra_ty_a_turnover.stringValue
        uiView.labelBTurnOver.text = MyVariables.defaultBranch.bra_ty_b_turnover.stringValue
        uiView.labelCTurnOver.text = MyVariables.defaultBranch.bra_ty_c_turnover.stringValue
        uiView.labelDTurnOver.text = MyVariables.defaultBranch.bra_ty_d_turnover.stringValue
        uiView.editBranch = MyVariables.defaultBranch
        self.instance.branchController = self
...
//        })
    ...
    func getBranchById(bra_id : NSNumber, uiView : ViewCustNotiSettingViewController) -> Void {
        ...
        uiView.labelRound1.text = MyVariables.defaultBranch.bra_noti_1.stringValue
        uiView.labelRound2.text = MyVariables.defaultBranch.bra_noti_2.stringValue
        uiView.labelRound3.text = MyVariables.defaultBranch.bra_noti_3.stringValue
        uiView.editBranch = self.branch
        self.instance.branchController = self
...
//        })
    ...
    func getBranchNameById(bra_id : NSNumber, uiView : MainDetailBranchViewController) -> Void {
        ...
        uiView.navigationItem.title = MyVariables.defaultBranch.bra_res_name as String + " [\(MyVariables.defaultBranch.bra_name)]"
        
        uiView.labelBranchName.text = MyVariables.defaultBranch.bra_name as String
        uiView.imageRestaurant.image = UIImage(named: "\(MyVariables.defaultBranch.bra_res_name).png")
        self.instance.branchController = self
...
//        })
    ...
    func updateItem(item: Branch) {
        ...
        MyVariables.defaultBranch.bra_noti_1 = item.bra_noti_1
        MyVariables.defaultBranch.bra_noti_2 = item.bra_noti_2
        MyVariables.defaultBranch.bra_noti_3 = item.bra_noti_3
