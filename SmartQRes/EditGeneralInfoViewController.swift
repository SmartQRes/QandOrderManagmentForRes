...
//        BranchController().checkDuplicateBranchName(editBranch, uiView: self)
        ...
        MyVariables.defaultBranch.bra_name = self.txtBranchName.text!
        MyVariables.defaultBranch.bra_location = self.txtBranchLocation.text!
        MyVariables.defaultBranch.bra_sho_id = selectMallId
        MyVariables.defaultBranch.bra_shop_name = selectMall
        MyVariables.defaultBranch.bra_service_time = self.txtServiceTime.text!
        MyVariables.defaultBranch.bra_status = selectStatusId
        MyVariables.defaultBranch.bra_status_name = selectStatus
        MyVariables.defaultBranch.bra_contact_no = self.txtContactNo.text!
