//
//  MasterResTableViewController.swift
//  SmartQRes
//
...
class MasterResTableViewController: UITableViewController {
...
*/
    ...
    */
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        switch row {
        case 0:
            self.performSegueWithIdentifier("manageBranchListResSegue", sender: self)
        case 1:
            self.performSegueWithIdentifier("custNotiResSegue", sender: self)
        default:
            print("Other")
